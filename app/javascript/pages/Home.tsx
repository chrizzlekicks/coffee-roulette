        ...
        <div class="hero-content text-center max-w-6xl mx-auto px-4">
          <div class="max-w-4xl">
            ...
            <p class="text-lg md:text-xl text-base-content/70 mb-8 max-w-3xl mx-auto leading-relaxed">
              Break down silos and build meaningful relationships with your team. Our smart matching algorithm pairs you
              with colleagues for spontaneous coffee chats that spark collaboration and friendship.
            </p>
          ...
          <div class="grid md:grid-cols-3 gap-8">
            <div class="card bg-base-200/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div class="card-body text-center">
                ...
                <p class="text-base-content/80">
                  Our algorithm intelligently pairs you with colleagues you haven't connected with recently, ensuring
                  diverse and meaningful interactions.
                </p>
              </div>
            </div>
            <div class="card bg-base-200/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div class="card-body text-center">
                ...
                <p class="text-base-content/80">
                  Get matched regularly for coffee chats that fit into your schedule. Build relationships one
            ...
            <div class="card bg-base-200/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div class="card-body text-center">
                ...
                <p class="text-base-content/80">
                  Simple signup, instant email notifications, and zero maintenance. Focus on the conversations, not the
                  logistics.
                </p>
              </div>
            </div>
      ...
      <section id="how-it-works" class="py-20 bg-base-200/30">
        <div class="max-w-4xl mx-auto px-4">
          <div class="text-center mb-16">
            ...
            <p class="text-lg text-base-content/70">Getting started is simple and takes less than 2 minutes</p>
          </div>
          <div class="space-y-12">
            <div class="flex flex-col md:flex-row items-center gap-8">
              ...
              <div class="flex-1 text-center md:text-left">
                ...
                <p class="text-base-content/80">
                  Create your account with just your email and name. Join your organization's CoffeeRoulette community.
                </p>
              </div>
            </div>
            <div class="flex flex-col md:flex-row items-center gap-8">
              ...
              <div class="flex-1 text-center md:text-left">
                ...
                <p class="text-base-content/80">
                  Our algorithm pairs you with colleagues for coffee meetups. Receive email notifications with your
                  match details.
                </p>
              </div>
            </div>
            <div class="flex flex-col md:flex-row items-center gap-8">
              ...
              <div class="flex-1 text-center md:text-left">
                ...
                <p class="text-base-content/80">
                  Meet up for coffee, tea, or a quick chat. Build meaningful relationships that enhance collaboration
      ...
      <section class="py-20 bg-base-100">
        <div class="max-w-6xl mx-auto px-4">
          <div class="text-center mb-16">
            ...
            <p class="text-lg text-base-content/70 max-w-2xl mx-auto">
              Join teams that are already building stronger connections and more collaborative cultures
            </p>
          </div>
          ...
          <div class="mt-16 grid md:grid-cols-2 gap-8">
            <div class="chat chat-start">
              <div class="chat-bubble chat-bubble-primary">
                "CoffeeRoulette helped me connect with people I never would have talked to otherwise. It's amazing how a
                simple coffee chat can lead to great collaborations!"
              </div>
            </div>
            <div class="chat chat-end">
              <div class="chat-bubble chat-bubble-secondary">
                "I was skeptical at first, but now I look forward to my coffee matches. It's the highlight of my week
                and has made work so much more enjoyable."
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="py-20 bg-gradient-to-r from-primary to-accent">
        <div class="max-w-4xl mx-auto text-center px-4">
          ...
          <p class="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Join thousands of professionals who are already building stronger workplace relationships through
            CoffeeRoulette
          </p>
          <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
